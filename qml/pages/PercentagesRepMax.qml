...
Page {
    ...
    property string brzycki_kg: parseFloat(Preferences.get("brzycki_kg_RepMax"))
    property string epley_kg: parseFloat(Preferences.get("epley_kg_RepMax"))
    property string lander_kg: parseFloat(Preferences.get("lander_kg_RepMax"))
    property string lombardi_kg: parseFloat(Preferences.get("lombardi_kg_RepMax"))
    property string mayhew_kg: parseFloat(Preferences.get("mayhew_kg_RepMax"))
    property string oconner_kg: parseFloat(Preferences.get("oconner_kg_RepMax"))
    property string wathan_kg: parseFloat(Preferences.get("wathan_kg_RepMax"))
    property string brzycki_lb: parseFloat(Preferences.get("brzycki_lb_RepMax"))
    property string epley_lb: parseFloat(Preferences.get("epley_lb_RepMax"))
    property string lander_lb: parseFloat(Preferences.get("lander_lb_RepMax"))
    property string lombardi_lb: parseFloat(Preferences.get("lombardi_lb_RepMax"))
    property string mayhew_lb: parseFloat(Preferences.get("mayhew_lb_RepMax"))
    property string oconner_lb: parseFloat(Preferences.get("oconner_lb_RepMax"))
    property string wathan_lb: parseFloat(Preferences.get("wathan_lb_RepMax"))
    ...
    SilicaListView {
        ...
        Grid {
            ...
            Repeater {
                ...
                Rectangle {
                    width: (percentagesRepMax.width / 8)
                    height: 140
                    color: "transparent"
    ...
    function addHeader() {
        var entries = 8
        var kgunit = parseInt(Preferences.get("kgUnit"))
